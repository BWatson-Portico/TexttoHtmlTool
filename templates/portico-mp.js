...
<span style="color:#001C41;font-size:18px;"><strong>${esc(title)}</strong></span>
</div></td></tr>` : '';
...
<tr><td colspan="2" height="2" bgcolor="#007AAF" style="height:2px;line-height:2px;">&nbsp;</td></tr>
...
<span style="font-size:16px;"> <a href="mailto:mail@PorticoBenefits.org" style="text-decoration:none;font-weight:normal;color:#000000;"><span style="font-family:helvetica,sans-serif;color:#007AAF;"><u>mail@PorticoBenefits.org</u></span></a></span>
</p></td></tr></table></td></tr>
<tr><td colspan="2" height="2" bgcolor="#005A8B" style="height:2px;line-height:2px;"></td></tr>
...
<div style="text-align:right;">${projectCode ? `<span style="font-family:helvetica,sans-serif;color:#545859;font-size:10px;">${projectCode}</span>&nbsp;` : ''}</div>
</td></tr>
</table>
</td></tr>
</table>
